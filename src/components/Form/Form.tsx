        ...
        <div className={'Form'}>
            ...
            <form>
                ...
                <div>
                    ...
                    {
                        validationError &&
                            <div className={'mt-2 text-danger'}>{validationError}</div>
                    }
                </div>
                }
                {action === 'withdraw' &&
                <div>
                    {account &&
                        <div className="deposit-button-wrapper">
                            ...
                            <button className="withdraw-all">Withdraw all</button>
                            <div className="direct-deposit">
                                <input type="checkbox" />
