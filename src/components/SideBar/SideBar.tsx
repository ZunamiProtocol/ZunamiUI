            ...
            <div className={`Sidebar ${props.isMainPage === false ? 'SideBar_hide' : ''}`}>
                ...
                </div>
                {
                    ...
                    <div className={'d-flex d-sm-none one-row'}>
                        <LinkBlock title="Deposit" description="Click for deposit" url={'deposit'}
                                   icon="/deposit-icon.svg" vstyle="selected"/>
                        <LinkBlock title="Withdraw" description="Click for withdraw" url={'withdraw'}
                                   icon="/withdraw-icon.svg" vstyle="selected"/>
                    </div>
                }
                <div className={'d-none d-sm-block'}>
                    <LinkBlock title="Dashboard" description="" url={''} icon="/dashboard-icon.svg"/>
                    <LinkBlock title="Deposit" description="Click for deposit" url={'deposit'} icon="/deposit-icon.svg"
                               vstyle="selected"/>
                    <LinkBlock title="Withdraw" description="Click for withdraw" url={'withdraw'}
                               icon="/withdraw-icon.svg" vstyle="selected"/>
                </div>
