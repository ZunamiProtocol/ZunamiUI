    ...
    return (
        <Navbar expand="lg" className={'header'}>
            {/* <Container className={'header-container'}> */}
                ...
                <Disclaimer text={<div>Please note. The contract has been <a target="_blank" rel="noreferrer" href="http://ya.ru">audited</a>, but it steel a beta version. Use it at your own risk</div>} />
            {/* </Container> */}
        </Navbar>
    );
};
