...
export const Analytics = (): JSX.Element => {
    ...
    const chartData = useMemo(() => {
        return poolStats && poolStats.pools && zunamiInfo
            ? poolDataToChartData(poolStats.pools, zunamiInfo.tvl)
            : []
    }, [poolStats, zunamiInfo]);
    ...
    const collateralData = useMemo(() => {
        ...
        return selectedStrat && selectedStrat.analytics.collateralData ? selectedStrat.analytics.collateralData.assets.map(asset => {
            return {
                        ...
                        <div className="">
                            <div className="ps-4">
                                <div className="container">
                                    ...
                                    {selectedStrat && (
                                        <div className="panel mt-4">
                                            <div className="d-flex gap-3">
                                                <div className="gray-block small-block align-items-start">
                                                    <div>Current APR, %</div>
                                                    <div>{selectedStrat.apr}</div>
                                                </div>
                                                <div className="gray-block small-block align-items-start">
                                                    <div>Base</div>
                                                    <div>{toFixed(selectedStrat.baseCurveApr)}</div>
                                                </div>
                                                <div className="gray-block small-block align-items-start">
                                                    <div>CRV, %</div>
                                                    <div>{toFixed(selectedStrat.crvApr)}</div>
                                                </div>
                                                <div className="gray-block small-block align-items-start">
                                                    <div>CVX, %</div>
                                                    <div>{toFixed(selectedStrat.cvxApr)}</div>
                                                </div>
                                                <div className="gray-block small-block align-items-start">
                                                    <div>Incentives, $</div>
                                                    <div>{toFixed(selectedStrat.additionalApr)}</div>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                                        ...
                                        <div className="col">
                                            <div className="tbl">
                                                ...
                                                <div>
                                                    ...
                                                    <div>{selectedStrat.analytics.coinsMarketData.stableCoin.marketCap}</div>
                                                </div>
                                                <div>
                                            ...
                                            <div className="col">
                                                <div className="tbl">
                                                    <div className="d-flex flex-wrap  align-items-center">
                                                        ...
                                                        <img src={selectedStrat.icon} alt="" />
                                                        </div>
                                                        <div className="about-uzd">
                                                            {
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <div className="mt-3 panel d-flex gap-3 disabled">
                                                <div className="gray-block small-block align-items-start">
                                                    <div>Price, $</div>
                                                    <div>8</div>
                                                </div>
                                    ...
                                    <div className="row mt-3 mb-3 risk-section disabled">
                                        <div className="col-md-4">
                                            <ul
