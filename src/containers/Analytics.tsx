...
function renderCoin(coin, coinIndex, selectedStrat) {
    return (
        ...
        <div className="buttons">
            ...
            >
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.38036 1L3.2854 1C1.57135 1 1 2.1427 1 3.2854C1 4.19957 1 5.18991 1 6.71351C1 7.85621 1.57135 8.99891 3.2854 8.99891C3.74248 8.99891 4.61856 8.99891 6.71351 8.99891C8.42756 8.99891 8.99891 7.85621 8.99891 6.71351V4.99946" stroke="black" strokeWidth="0.9" strokeLinecap="round"/>
                    <path d="M5 4.99946L8.99946 1M8.99946 1H7.22192M8.99946 1V2.77754" stroke="black" strokeWidth="0.9" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            </a>
        </div>
    </div>
...
export const Analytics = (): JSX.Element => {
    ...
    const collateralData = useMemo(() => {
        ...
        const total = selectedStrat && selectedStrat.analytics.collateralData
            ? selectedStrat.analytics.collateralData.assets.map(asset => asset.totalUsdCollateral).reduce((a, b) => a + b, 0)
            : 0;
        ...
        if (selectedStrat && selectedStrat.analytics.collateralData) {
            ...
            result.collaterals = result.collaterals.sort((a, b) => a.totalUsdCollateral > b.totalUsdCollateral ? -1 : 0)
        }
                                                ...
                                                {chartData.map((pool, poolIndex) => (
                                                    ...
                                                    >
                                                        <div className="wrapper">
                                                            ...
                                                            <div className="coin">
                                                                <img src='/curve-icon.svg' alt={pool.title} />
                                                            </div>
                                                        </div>
                                                        <div>
                                        ...
                                        <div className="row selected-strat">
                                            <div className="col">
                                                <div className="tbl align-items-center">
                                                    <div className="d-flex flex-wrap md-w-100 w-100">
                                                        <div className="d-flex mt-0 new-coin pool-info-coin">
                                                            <div className="wrapper">
                                                                ...
                                                                />
                                                                <div className="coin">
                                                                    <img src={selectedStrat.icon} alt={selectedStrat.title} />
                                                                </div>
                                                                <div className="coin">
                                                                    <img src='/curve-icon.svg' alt={selectedStrat.title} />
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <div className="name">
                                                    ...
                                                    <div>
                                                        <div className="subtitle text-nowrap">Zunami Allocation</div>
                                                        <div className="vela-sans">
                                                            ${Number(
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="vela-sans">${selectedStrat.analytics.curveData.data.usdTotal.toLocaleString('en', { maximumFractionDigits: 0 })}</div>
                                                    </div>
                                                    <div>
                                        ...
                                        <div className="panel mt-4">
                                            <div className="row">
                                                <div className="col-md-8 gap-3 mb-2 d-flex align-items-start">
                                                    ...
                                                    <div>
                                                        {
                                                            selectedStrat.analytics.curveData.data.underlyingCoins.filter(item => item.address !== mainCoin.address).map((coin, coinIndex) => 
                                                                renderCoin(coin, coinIndex, selectedStrat)
                                                            )
                                                        }
                                                    </div>
                                                </div>
                                    ...
                                    {selectedStrat && (
                                        <div className="panel mt-4">
                                            <div className="d-flex gap-3 flex-wrap xs-2-col">
                                                <div className="gray-block small-block align-items-start" style={{width: '150px'}}>
                                                    <div>Current APR, %</div>
                                                    <div className="vela-sans">{selectedStrat.apr.toFixed(2)}</div>
                                                </div>
                                                <div className="gray-block small-block align-items-start">
                                                    <div>Base</div>
                                                    <div className="vela-sans">{toFixed(selectedStrat.baseCurveApr)}</div>
                                                </div>
                                                <div className="gray-block small-block align-items-start">
                                                    <div>CRV, %</div>
                                                    <div className="vela-sans">{toFixed(selectedStrat.crvApr)}</div>
                                                </div>
                                                <div className="gray-block small-block align-items-start">
                                                    <div>CVX, %</div>
                                                    <div className="vela-sans">{toFixed(selectedStrat.cvxApr)}</div>
                                                </div>
                                                <div className="gray-block small-block align-items-start">
                                                    <div>FXS, %</div>
                                                    <div className="vela-sans">{toFixed(selectedStrat.additionalApr)}</div>
                                                </div>
                                            </div>
                                            {
                                                selectedStrat.analytics.convexData && (
                                                    <div className="d-flex gap-3 flex-wrap xs-2-col mt-3">
                                                        <div className="gray-block small-block align-items-start" style={{width: '150px'}}>
                                                            ...
                                                            <div className="vela-sans">
                                                                {toFixed(
                                                                    selectedStrat.analytics.convexData.projectedApr.baseCrvApr + 
                                                                    selectedStrat.analytics.convexData.projectedApr.crvApr + 
                                                                    selectedStrat.analytics.convexData.projectedApr.cvxApr
                                                                )}
                                                            </div>
                                                        </div>
                                                        <div className="gray-block small-block align-items-start">
                                                            <div>Base</div>
                                                            <div className="vela-sans">{toFixed(selectedStrat.analytics.convexData.projectedApr.baseCrvApr)}</div>
                                                        </div>
                                                        <div className="gray-block small-block align-items-start">
                                                            <div>CRV, %</div>
                                                            <div className="vela-sans">{toFixed(selectedStrat.analytics.convexData.projectedApr.crvApr)}</div>
                                                        </div>
                                                        <div className="gray-block small-block align-items-start">
                                                            <div>CVX, %</div>
                                                            <div className="vela-sans">{toFixed(selectedStrat.analytics.convexData.projectedApr.cvxApr)}</div>
                                                        </div>
                                                        {/* <div className="gray-block small-block align-items-start">
                                                            <div>Incentives, %</div>
                                                    ...
                                                    <div className="about-uzd">
                                                        {
                                                            selectedStrat.analytics.protocolInfo.info.stableCoinInfo
                                                                .split("\n")
                                                                .map((paragraph: string, parIndex) => <p key={parIndex} className="text-break mw-100">{paragraph}</p>)
                                                        }
                                                    </div>
                                                </div>
                                                <div>
                                                ...
                                                <div className="tbl xs-1-col">
                                                    <div className="logo-col">
                                                        <div className="logos protocol-logos">
                                                            <img src={getPoolIcon(selectedStrat.type)} alt="" />
                                                        </div>
                                                        <div className="about-uzd">
                                                            {
                                                                selectedStrat.analytics.protocolInfo.info.protocolDescription
                                                                    .split("\n")
                                                                    .map((paragraph: string, parIndex) => <p key={parIndex} className="text-break">{paragraph}</p>)
                                                            }
                                                        </div>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <div className="native-token">
                                                            <img src={selectedStrat.analytics.coinsMarketData.nativeCoin.image} alt="" />
                                                            <span>{selectedStrat.analytics.coinsMarketData.nativeCoin.name}</span>
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <div className="row">
                                            <div className="col">
                                                <div className="mt-3 panel d-flex gap-3 flex-wrap xs-1-col">
                                                    <div className="gray-block small-block align-items-start">
                                                        <div>Price, $</div>
                                                        <div className="vela-sans">{selectedStrat.analytics.coinsMarketData.nativeCoin.currentPrice}</div>
                                                    </div>
                                                    <div className="gray-block small-block align-items-start">
                                                        <div>Total Volume, $</div>
                                                        <div className="vela-sans">{selectedStrat.analytics.coinsMarketData.nativeCoin.totalVolume.toLocaleString('en', { maximumFractionDigits: 0 })}</div>
                                                    </div>
                                                    <div className="gray-block small-block align-items-start">
                                                        <div>Market Rank</div>
                                                        <div className="vela-sans">{selectedStrat.analytics.coinsMarketData.nativeCoin.marketCapRank}</div>
                                                    </div>
                                                    {renderTreasury(selectedStrat.analytics.treasuryData, selectedStrat.type)}
                                                </div>
                                            </div>
                                        </div>
                                    )}
                                            ...
                                            <div className="row mt-3 mb-3 risk-section">
                                                <div className="col-md-4">
                                                    ...
                                                    >
                                                        ...
                                                        <li className="nav-item" role="presentation">
                                                            <button
                                                                className={`nav-link ${selectedTabIndex === 4 ? 'active' : ''}`}
                                                            ...
                                                            >
                                                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <circle cx="15" cy="15" r="13.65" stroke="#090909" strokeWidth="1.3"/>
                                                                    <rect x="11.35" y="11.35" width="7.3" height="7.3" stroke="#090909" strokeWidth="1.3"/>
                                                                </svg>
                                                                <span>Risk of stop incentivization</span>
                                                                <div className="circle"></div>
                                                            </button>
                                                        </li>
                                                    </ul>
