...
export const Uzd = (): JSX.Element => {
    ...
    // set initial balances to inputs
    useEffect(() => {
        if (lpPrice.toNumber() === 0) {
            return;
        }

        setZunLpValue(getFullDisplayBalance(zlpBalance));
        setUzdValue(getFullDisplayBalance(zlpBalance.multipliedBy(lpPrice)));
    }, [zlpBalance, lpPrice]);
    ...
    useEffect(() => {
        if (mode === 'redeem') {
            setUzdValue(getFullDisplayBalance(uzdBalance));
        }
    }, [mode, uzdBalance]);
    ...
    const withdrawDisabled =
        ...
        pendingTx ||
        parseFloat(uzdValue) > parseFloat(getFullDisplayBalance(uzdBalance));
                                            ...
                                            <div className="right-part">
                                                ...
                                                {mode === 'mint' && (
                                                    <div
                                                        ...
                                                        onClick={() => {
                                                            setZunLpValue(
                                                                getFullDisplayBalance(zlpBalance)
                                                            );
                            ...
                            <div className={`col-sm-6 col-12`}>
                                {mode === 'redeem' && (
                                    <div>
                                        ...
                                        <a href="https://curve.com" className="go-to-curve">
                                            <img src="/curve-icon.svg" alt="" />
