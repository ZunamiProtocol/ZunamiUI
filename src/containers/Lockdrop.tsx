                                        ...
                                        <div className="d-flex">
                                            <div className="Lockdrop__Locked">
                                                ...
                                                <div className="Lockdrop__Locked__Range">
                                                    <input type="range" min="1" max="16" value="8" readOnly />
                                                </div>
                                                <div className="Lockdrop__Locked__Period">
                                                    <span>Lock for </span>
                                                    <span className="active">8 weeks</span>
                                                </div>
                                                <div className="Lockdrop__Locked__Token">
                                                    <img src="/zun-token.svg" alt="" className="icon" />
                                                    <span className="token">ZUN LP</span>
                                            ...
                                            <div className="Lockdrop__Unclaimed">
                                                <div className="Lockdrop__Unclaimed__Title">Unclaimed Rewards</div>
                                                <div className="Lockdrop__Unclaimed__ZUN">ZUN 1.300,54</div>
                                                <div className="Lockdrop__Unclaimed__USD">$4.504,60</div>
                                                <button>Claim</button>
                                                <svg className="Lockdrop__Unclaimed__ICON" width="56" height="58" viewBox="0 0 56 58" fill="none" xmlns="http://www.w3.org/2000/svg">
