...
import { HistoryTable } from '../components/Staking/HistoryTable/HistoryTable';
...
import { Input } from '../components/Staking/Input/Input';
                                ...
                                <div className="Staking">
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="Staking__Unclaimed">
                                            ...
                                            <ClaimItem zun={1300.54} usd={4504.6} />
                                            <svg
                                                className="Staking__Unclaimed__ICON"
                                                width="56"
                                                height="58"
                                                viewBox="0 0 56 58"
                                                fill="none"
